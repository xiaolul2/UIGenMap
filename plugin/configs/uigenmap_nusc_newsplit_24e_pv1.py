...
pv_ckpt="/share/home/22251335/lxl/Projects/StreamMapNet_2d/work_dirs/nusc_newsplit_480_60x30_24e_pts2q_un7/iter_83520_o.pth"
model = dict(
    type='UIGenMap',
    roi_size=roi_size,
    bev_h=bev_h,
    ...
    backbone_cfg=dict(
        type='BEVFormerBackbone_2D',
        
        use_grid_mask=True,
        img_backbone=dict(
            type='ResNet',
            with_cp=False,
            #pretrained='/share/home/22251335/lxl/Projects/StreamMapNet/resnet50_msra-5891d200.pth',
    ...
    pv_head_cfg=dict(
        type='MapDetectorHead_2D', 
        num_queries=pv_num_queries,
        embed_dims=pv_embed_dims,
        num_classes=num_class,
        in_channels=pv_embed_dims//2,
        num_points=num_points,
        roi_size=roi_size,
        coord_dim=2,
        different_heads=False,
        ...
        transformer=dict(
            ...
            decoder=dict(
                type='MapTransformerDecoder_PV_un',
                num_layers=6,
                prop_add_stage=1,
                return_intermediate=True,
                transformerlayers=dict(
                    ...
                    ffn_cfgs=dict(
                        type='FFN',
                        embed_dims=pv_embed_dims,
                        feedforward_channels=pv_embed_dims*2,
                        num_fcs=2,
                        ffn_drop=0.1,
                        act_cfg=dict(type='ReLU', inplace=True),        
                    ),
...
train_pipeline = [
    ...
    dict(type='Collect3D', keys=['img', 'vectors','pv_vectors'], meta_keys=(
