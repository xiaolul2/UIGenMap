...
##    """
##
##    def __init__(self, sat_path,to_float32=False, color_type='unchanged'):
##        self.to_float32 = to_float32
##        self.color_type = color_type
##
...
##                - img_norm_cfg (dict): Normalization configuration of images.
##        """
##        filename = results['prior_filename']
##        filename = osp.join( self.sat_path , filename)
##        img = mmcv.imread(filename, self.color_type)
##        if self.to_float32:
##            img = img.astype(np.float32)#[i.astype(np.float32) for i in img]+
##            
##        #flip
...
##                tmp, self.mean, self.std, self.to_rgb)
##
##        
##        
##        results['map_prior'] = img
##        # results['img_shape'] = [i.shape for i in img]
##        # results['ori_shape'] = [i.shape for i in img]
##        # # Set initial values for default meta_keys
##        # results['pad_shape'] = [i.shape for i in img]
...
##class LoadPointsFromFile_1(object):
...
##            #改
##            ego2img= torch.tensor(results["ego2img"][cid]).to(torch.float32)
##            lidar2img = ego2img.matmul(lidar2lidarego)
...
##        #################################################################
##
##        results['gt_depth'] = depth_map_list
##        return results
