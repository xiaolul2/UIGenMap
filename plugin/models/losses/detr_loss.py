...
class PtsNLLLoss1(nn.Module):
    ...
    def __init__(self, reduction='mean', loss_weight=0.5,loss_weight_L1=50.0,beta_L1=0.01):
        super(PtsNLLLoss1, self).__init__()
    ...
    def forward(self,
        ...
        # breakpoint()
        #ori loss
        loss_bbox_L1 = smooth_l1_loss(pred[:,0:40], target, weight, reduction=reduction, avg_factor=avg_factor, beta=self.beta_L1)
        ...
        loss_bbox = pts_nll_loss_laplace(pred, target, weight, reduction=reduction, avg_factor=avg_factor)
        ...
        loss_L1 = loss_bbox_L1 / num_points

        return self.loss_weight*loss + loss_L1*self.loss_weight_L1
